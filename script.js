...
const PRODUCTS = [
  ...
  { id:2, name:'Atún en agua 170g', brand:'AyB', cat:'conservas', price:6.50, unit:'/lata', sku:'AYB-CON-170' },
  { id:3, name:'Spaghetti 500g', brand:'AyB', cat:'pastas', price:3.60, unit:'/bolsa', sku:'AYB-PAS-500' },
  { id:4, name:'Mermelada Fresa 250g', brand:'AyB', cat:'dulces', price:7.90, unit:'/frasco', sku:'AYB-DUL-250' },
  { id:5, name:'Jabón en barra 175g', brand:'Estelar', cat:'limpieza', price:1.20, unit:'/unidad', sku:'EST-LIM-175' },
  { id:6, name:'Detergente 1L', brand:'Estelar', cat:'limpieza', price:8.50, unit:'/botella', sku:'EST-LIM-1L' },
  { id:7, name:'Aceite de Soya 18L', brand:'AyB', cat:'aceites', price:125.00, unit:'/lata', sku:'AYB-ACE-18L' },
];
